...
readonly TEXT_BLINK=5
readonly TEXT_REVERSE=7
readonly TEXT_HIDDEN=8

readonly TEXT_RESET_BOLD_BRIGHT=21
readonly TEXT_RESET_DIM=22
readonly TEXT_RESET_UNDERLINED=24
readonly TEXT_RESET_BLINK=25
readonly TEXT_RESET_REVERSE=27
readonly TEXT_RESET_HIDDEN=28

# ************ 颜色 ***************
# 前景色
readonly COLOR_F_DEFAULT=39
readonly COLOR_F_BLACK=30
readonly COLOR_F_RED=31
readonly COLOR_F_GREEN=32
readonly COLOR_F_YELLOW=33
readonly COLOR_F_BLUE=34
readonly COLOR_F_MAGENTA=35
readonly COLOR_F_CYAN=36
readonly COLOR_F_LIGHT_GRAY=37
readonly COLOR_F_DARK_GRAY=90
readonly COLOR_F_LIGHT_RED=91
readonly COLOR_F_LIGHT_GREEN=92
readonly COLOR_F_LIGHT_YELLOW=93
readonly COLOR_F_LIGHT_BLUE=94
readonly COLOR_F_LIGHT_MAGENTA=95
readonly COLOR_F_LIGHT_CYAN=96
readonly COLOR_F_WHITE=97

# 背景色
readonly COLOR_B_DEFAULT=49
readonly COLOR_B_BLACK=40
readonly COLOR_B_RED=41
readonly COLOR_B_GREEN=42
readonly COLOR_B_YELLOW=43
readonly COLOR_B_BLUE=44
readonly COLOR_B_MAGENTA=45
readonly COLOR_B_CYAN=46
readonly COLOR_B_LIGHT_GRAY=47
readonly COLOR_B_DARK_GRAY=100
readonly COLOR_B_LIGHT_RED=101
readonly COLOR_B_LIGHT_GREEN=102
readonly COLOR_B_LIGHT_YELLOW=103
readonly COLOR_B_LIGHT_BLUE=104
readonly COLOR_B_LIGHT_MAGENTA=105
readonly COLOR_B_LIGHT_CYAN=106
readonly COLOR_B_WHITE=107
